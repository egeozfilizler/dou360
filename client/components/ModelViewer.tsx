...
const ModelInner: FC<ModelInnerProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    if (autoFrame && (camera as THREE.PerspectiveCamera).isPerspectiveCamera) {
      ...
      persp.near = d / 10;
      // Clamp far plane so we don't create a huge depth range, which can
      // increase GPU / memory pressure and lead to context loss.
      persp.far = Math.min(d * 10, 200);
...
const ModelViewer: FC<ViewerProps> = ({
  ...
  return (
    ...
    >
      ...
      <Canvas
        frameloop="demand"
        // Lower DPR and disable antialiasing to reduce GPU / memory pressure,
        // similar to the "render at lower resolution" advice in
